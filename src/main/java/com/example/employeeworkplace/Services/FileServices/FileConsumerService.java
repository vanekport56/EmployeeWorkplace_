package com.example.employeeworkplace.Services.FileServices;
 ...
 * Слушает сообщения из "file-topic", преобразует их из JSON в сущности {@link FileEntity}
...
public class FileConsumerService {
    ...
    /**
     * Метод-слушатель Kafka для обработки сообщений из "file-topic".
